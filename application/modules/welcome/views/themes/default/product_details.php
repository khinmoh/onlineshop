            ...
            <div class="span6">
                ...
                <form class="form-horizontal qtyFrm" method="post" action="">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="number" class="span1" placeholder="Qty." name="qty" id="qty" min="1"/>
                            <button type="button" class="btn btn-large pull-right" id="addtocart" data-pid="<?= $product['product_id'] ?>" data-uid="<?php echo $userid; ?>" data-price="<?= $product['product_price'] ?>"><i class=" icon-shopping-cart"></i> Add to cart</button>
                        </div>
                    </div>
                </form>
