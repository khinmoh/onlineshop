...
<!DOCTYPE html>
		...
		<div class="col-sm-12">
		  ...
		  <div class="form-row form-group">
			...
			<input type="submit" class="submit btn btn-primary" value="Submit Payment">
                  ...
                  <input type="hidden" name="totalamount" value="<?php echo $totalamount;?>" id="amount" />
	...
	<script type="text/javascript">
	  ...
	  Stripe.setPublishableKey('pk_test_KCTsJjM3bQI6RY7HVUDaoJ7t');
	 ...
	 function stripeResponseHandler(status, response) {
		 ...
		 if (response.error) {
			...
			$.ajax({
				...
				data: {access_token: response.id, amount:amount, userid:userid},
				type: 'POST',
				dataType: 'JSON',
